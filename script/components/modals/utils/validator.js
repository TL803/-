export class FormValidator {
  constructor(formElement, onSuccess) {
    ...
    this.fullnameInput = formElement.querySelector('input[name="fullname"]');
  ...
  async submitForm() {
    try {
      ...
      console.error('Ошибка при имитации отправки:', error);
      this.showError(this.phoneInput, 'Не удалось отправить заявку. Попробуйте позже.');
    }
  }
}